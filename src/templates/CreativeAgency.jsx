...
export default function CreativeAgency({ data }) {
  return (
    <div className="template creative-agency">
      {/* Hero Section */}
      <section className="hero gradient-orange">
      ...
      <section className="section services-section bg-dark">
        <div className="container">
          <h2 className="section-title text-white">{data.services_heading}</h2>
          <p className="section-text text-white">{data.services_paragraph}</p>
        </div>
      </section>
